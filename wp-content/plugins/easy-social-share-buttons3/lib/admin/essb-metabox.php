...
function essb_register_settings_metabox_onoff() {
	...
	if (isset ( $_GET ['action'] )) {
		...
		if ($twitter_counters == "self") {
			ESSBOptionsFramework::draw_options_row_start_full('inner-row');
			ESSBOptionsFramework::draw_title ( esc_html__ ( 'Twitter Internal Share Counter', 'essb' ), '', 'inner-row' );
			ESSBOptionsFramework::draw_options_row_end ();
		...
		if (essb_option_value('linkedin_counter_type') != 'no') {
		    ESSBOptionsFramework::draw_options_row_start_full('inner-row');
		    ESSBOptionsFramework::draw_title ( esc_html__ ( 'LinkedIn Internal Share Counter', 'essb' ), '', 'inner-row' );
		    ESSBOptionsFramework::draw_options_row_end ();
		    
		    ESSBOptionsFramework::draw_options_row_start_full('inner-row-small');
		    ESSBOptionsFramework::draw_input_field('essb_pc_linkedin', true, 'essb_metabox', $essb_pc_linkedin);
		    ESSBOptionsFramework::draw_options_row_end ();
		}
