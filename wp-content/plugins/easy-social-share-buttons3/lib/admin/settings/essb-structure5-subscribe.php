...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-11', 'essb3_ofob|posttypes', esc_html__('Post types', 'essb'), esc_html__('You can choose the post types where pop-up forms will show. Leave blank for the entire website.', 'essb'), ESSB_Plugin_Loader::supported_post_types(false, false), '', '', 'true');
...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-11', 'essb3_ofob|of_time_close', esc_html__('Choose close type', 'essb'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-11', 'essb3_ofob|of_scroll_close', esc_html__('Choose close type', 'essb'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-11', 'essb3_ofob|of_exit_close', esc_html__('Choose close type', 'essb'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-11', 'essb3_ofob|of_manual_close', esc_html__('Choose close type', 'essb'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|posttypes', esc_html__('Post types', 'essb'), esc_html__('You can choose the post types where pop-up forms will show. Leave blank for the entire website.', 'essb'), ESSB_Plugin_Loader::supported_post_types(false, false), '', '', 'true');
...
ESSBOptionsStructureHelper::field_textbox('subscribe', 'optin-12', 'essb3_ofof|ofof_time_delay', esc_html__('Display after seconds', 'easy-optin-flyout'), esc_html__('If you wish to display it immediately after load use 1 as value. Otherwise provide value of seconds you wish to use. Blank field will avoid display of opt-in form', 'easy-optin-flyout'), '', 'input60', 'fa-clock-o', 'right');
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|of_time_design', esc_html__('Choose design for that event', 'easy-optin-flyout'), esc_html__('Choose design which will be used for that event. You can have different design on each event', 'easy-optin-flyout'), essb_optin_designs());
ESSBOptionsStructureHelper::field_color('subscribe', 'optin-12', 'essb3_ofof|of_time_bgcolor', esc_html__('Overlay background color', 'easy-optin-flyout'), esc_html__('Change overlay background color that will be used for that event. You may need to replace the color if you customize design of chosen template.', 'easy-optin-flyout'), '', 'true');
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|of_time_close', esc_html__('Choose close type', 'easy-optin-flyout'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
ESSBOptionsStructureHelper::field_color('subscribe', 'optin-12', 'essb3_ofof|of_time_closecolor', esc_html__('Close action color', 'easy-optin-flyout'), esc_html__('Customize close action color in case you change overlay color. Otherwise you can leave the default', 'easy-optin-flyout'));
ESSBOptionsStructureHelper::field_textbox('subscribe', 'optin-12', 'essb3_ofof|of_time_closetext', esc_html__('Custom close text', 'easy-optin-flyout'), esc_html__('Enter custom close text when you choose text mode of close function.', 'easy-optin-flyout'), '');
ESSBOptionsStructureHelper::holder_end('subscribe', 'optin-12');
...
ESSBOptionsStructureHelper::field_textbox('subscribe', 'optin-12', 'essb3_ofof|ofof_scroll_percent', esc_html__('Percent of content', 'easy-optin-flyout'), esc_html__('Use numeric value without symbols. Exmaple: 40', 'easy-optin-flyout'), '', 'input60', 'fa-long-arrow-down', 'right');
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|of_scroll_design', esc_html__('Choose design for that event', 'easy-optin-flyout'), esc_html__('Choose design which will be used for that event. You can have different design on each event', 'easy-optin-flyout'), essb_optin_designs());
ESSBOptionsStructureHelper::field_color('subscribe', 'optin-12', 'essb3_ofof|of_scroll_bgcolor', esc_html__('Overlay background color', 'easy-optin-flyout'), esc_html__('Change overlay background color that will be used for that event. You may need to replace the color if you customize design of chosen template.', 'easy-optin-flyout'), '', 'true');
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|of_scroll_close', esc_html__('Choose close type', 'easy-optin-flyout'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
ESSBOptionsStructureHelper::field_color('subscribe', 'optin-12', 'essb3_ofof|of_scroll_closecolor', esc_html__('Close action color', 'easy-optin-flyout'), esc_html__('Customize close action color in case you change overlay color. Otherwise you can leave the default', 'easy-optin-flyout'));
ESSBOptionsStructureHelper::field_textbox('subscribe', 'optin-12', 'essb3_ofof|of_scroll_closetext', esc_html__('Custom close text', 'easy-optin-flyout'), esc_html__('Enter custom close text when you choose text mode of close function.', 'easy-optin-flyout'), '');
ESSBOptionsStructureHelper::holder_end('subscribe', 'optin-12');
...
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|of_exit_design', esc_html__('Choose design for that event', 'easy-optin-flyout'), esc_html__('Choose design which will be used for that event. You can have different design on each event', 'easy-optin-flyout'), essb_optin_designs());
ESSBOptionsStructureHelper::field_color('subscribe', 'optin-12', 'essb3_ofof|of_exit_bgcolor', esc_html__('Overlay background color', 'easy-optin-flyout'), esc_html__('Change overlay background color that will be used for that event. You may need to replace the color if you customize design of chosen template.', 'easy-optin-flyout'), '', 'true');
ESSBOptionsStructureHelper::field_select('subscribe', 'optin-12', 'essb3_ofof|of_exit_close', esc_html__('Choose close type', 'easy-optin-flyout'), esc_html__('Choose how you wish to close the pop up form - with close icon or text link.', 'essb-optin-booster'), array("icon" => "Close Icon", "text" => "Text close link"));
ESSBOptionsStructureHelper::field_color('subscribe', 'optin-12', 'essb3_ofof|of_exit_closecolor', esc_html__('Close action color', 'easy-optin-flyout'), esc_html__('Customize close action color in case you change overlay color. Otherwise you can leave the default', 'easy-optin-flyout'));
ESSBOptionsStructureHelper::field_textbox('subscribe', 'optin-12', 'essb3_ofof|of_exit_closetext', esc_html__('Custom close text', 'easy-optin-flyout'), esc_html__('Enter custom close text when you choose text mode of close function.', 'easy-optin-flyout'), '');
ESSBOptionsStructureHelper::holder_end('subscribe', 'optin-12');
...
if (!essb_option_bool_value('deactivate_module_conversions')) {
	ESSBOptionsStructureHelper::field_switch('subscribe', 'optin-1', 'conversions_subscribe_lite_run', esc_html__('Track subscribe forms conversion', 'essb') . essb_generate_expert_badge(), esc_html__('Conversion tracking collects information on page load and with the form interaction. As of those it may be too hard pressed for your webserver. Use caution and always monitor the site\'s performance. If you note a problem deactivate it immediately.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
}
