...
ESSBOptionsStructureHelper::holder_start('advanced', 'optimization', 'essb-related-heading7 mb40', '');
ESSBOptionsStructureHelper::hint('advanced', 'optimization', '', esc_html__('Combine CSS merges all your files into 1, reducing HTTP requests. Not recommended if your site uses HTTP/2 or a cache plugin.', 'essb'), '', 'glowhint');
...
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'precompiled_unique', esc_html__('Generate unique filename', 'essb'), '', '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
ESSBOptionsStructureHelper::field_switch('advanced', 'optimization', 'precompiled_footer', esc_html__('Move loading of the CSS styles to the footer', 'essb'), '', '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
/**
 * @since 7.3.2
 */
...
ESSBOptionsStructureHelper::field_switch('advanced', 'integrate', 'gutenberg_disable_pinterenst', esc_html__('Deactivate Gutenberg image block integration with Pinterest', 'essb'), esc_html__('Stop the additional fields in the Gutenberg Image block for Pinterest sharing.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
ESSBOptionsStructureHelper::panel_end('advanced', 'integrate');
