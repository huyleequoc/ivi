...
if( !class_exists("Zombify_RankedlistQuiz") ) {

    /**
     * Class Zombify_RankedlistQuiz
     */
    class Zombify_RankedlistQuiz extends Zombify_BaseQuiz
    {
         ...
         * @var string
         */
        public $slug = 'rankedlist';

        public $pagination_path = array('list');

        /**
         * Zombify Ranked List Quiz Structure
         *
         * @return Array
         */
