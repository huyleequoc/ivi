...
if ( isset( zf_array_values( $question["image"] )[0]["attachment_id"] ) || $question["embed_url"] != '' ) {
		...
		<div class="zf-media">
			...
			if ( isset( $question["image_credit"] ) && $question["image_credit"] ) { ?>
				<figcaption class="zf-figcaption">
					<cite><a href="<?php echo $question["image_credit"]; ?>" class="zf-media_credit" target="_blank"
							 rel="nofollow noopener"><?php echo $question["image_credit_text"] ? $question["image_credit_text"] : __( 'Credit', 'zombify' ); ?></a></cite>
				</figcaption>
			<?php } ?>
		</div>
	</figure>
