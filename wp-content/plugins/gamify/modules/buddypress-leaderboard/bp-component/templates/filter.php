 ...
 */
?>
<li id="gfy-bp-leaderboard-filter-select" class="last">
	<form action="" method="get">
		<label for="gfy-bp-leaderboard-filter-by"><?php _e( 'Show', 'gamify' ) ?>:</label>
		<select id="gfy-bp-leaderboard-filter-by" name="<?php echo $filter_name; ?>" onchange="this.form.submit();">
